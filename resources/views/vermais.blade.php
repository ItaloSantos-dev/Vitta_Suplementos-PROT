...
@section('conteudo')
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-md-5">
            ...
            <div>
                <a href="{{route('produtos.pormarcas', $produto->marca->id)}}"><span class="badge bg-success spanhover mb-3 px-3 py-2">{{ $produto->marca->nome }}</span></a>
                <a href="{{route('produtos.filtro', $produto->categoria->nome)}}"><span class="badge bg-success spanhover mb-3 px-3 py-2">{{$produto->categoria->nome}}</span></a>
            </div>
